...
const ReplyForm = ({ user, replyAt, getComments, id }) => {
  ...
  const onSubmit = async (data) => {
    const newData = {
      ...
      replyAt: replyAt.firstName + " " + replyAt.lastName,
    };
    setLoading(true);
    const res = await axiosInstance.post(`/posts/reply-comment/${id}`, newData);
